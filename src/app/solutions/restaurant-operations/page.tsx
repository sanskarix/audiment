...
export const metadata: Metadata = {
  title: "Restaurant Audit Software | Stop Fake Store Walks | Audiment",
  description:
    "Audiment is the high-trust operational execution platform for multi-unit restaurants. Enforce photo evidence, FSSAI compliance, and 48-hour corrective actions.",
  keywords: [
