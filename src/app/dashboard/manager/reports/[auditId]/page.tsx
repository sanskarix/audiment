      ...
      <div className="dashboard-page-container">
        <div className="page-header-section mb-xl flex flex-col md:flex-row md:items-start justify-between gap-xl">
          <div className="flex flex-col gap-xs">
            <Button variant="ghost" asChild className="-ml-4 gap-2 text-muted-text font-medium  tracking-widest text-xs hover:bg-transparent hover:text-primary transition-colors">
          ...
          <Button
            ...
            className="font-medium gap-2 h-10 px-6  tracking-widest text-xs shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95 mt-4 md:mt-0"
          >
        ...
        <div ref={reportRef} className="standard-card p-xl md:p-2xl bg-background border border-border/50">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-border/50 pb-xl mb-xl gap-xl">
            <div className="flex flex-col gap-md flex-1">
              <div className="flex items-center gap-3">
                <Badge variant="outline" className="text-[10px] font-medium tracking-widest  px-2 py-0.5 border-border text-muted-text bg-muted/30">STRATEGIC DOSSIER</Badge>
                <Badge variant="outline" className="text-[10px] font-medium tracking-widest  px-2 py-0.5 bg-success/10 text-success border-success/30">VERIFIED</Badge>
              </div>
              <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-heading ">{audit.templateTitle}</h1>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-lg pt-2">
                <div className="flex flex-col gap-xs">
                  <p className="text-[10px] font-normal text-muted-text  tracking-widest">Inspected Location</p>
                ...
                <div className="flex flex-col gap-xs">
                  <p className="text-[10px] font-normal text-muted-text  tracking-widest">Submission Date</p>
                ...
                <div className="flex flex-col gap-xs col-span-2 md:col-span-1">
                  <p className="text-[10px] font-normal text-muted-text  tracking-widest">Field Auditor</p>
            ...
            <div className="flex flex-col items-center justify-center bg-muted/10 border border-border/50 p-xl rounded-2xl min-w-[200px] shadow-sm">
              <p className="text-[10px] font-normal tracking-widest  text-muted-text">SCORE INDEX</p>
                      ...
                      <div className="flex flex-col md:flex-row md:items-start justify-between gap-xl">
                        <div className="flex flex-col gap-sm">
                          ...
                          <div className="flex flex-wrap items-center gap-3">
                            <Badge variant="outline" className="text-[10px] font-medium  py-0.5 px-2 border-border text-muted-text tracking-widest">
                        ...
                        <div className="flex flex-col items-start md:items-end gap-1.5 min-w-[120px]">
                          <div className={cn(
                            "flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium  tracking-widest border",
                          ...
                          <p className="text-[10px] font-normal text-muted-text  tracking-widest opacity-60 tabular-nums">{resp.score} / {resp.maxScore || 10} PTS</p>
                        </div>
                      </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-md mt-sm">
                          {resp.photoUrls.map((url: string, pi: number) => (
                            <div key={pi} className="group relative aspect-square rounded-xl overflow-hidden border border-border/50 shadow-sm bg-muted/10 transition-transform hover:scale-105 active:scale-95">
                              ...
                              <div className="absolute bottom-2 right-2 bg-background/90 px-2 py-0.5 rounded-md text-[9px] font-medium text-muted-text  tracking-widest border border-border/50">IMG_{pi + 1}</div>
                            </div>
                          ))}
                        </div>
                      )}
          ...
          {/* Footer Signature */}
          <div className="mt-xl pt-xl border-t border-border/50 flex flex-col md:flex-row items-center justify-between text-[10px] text-muted-text font-normal  tracking-widest gap-md">
