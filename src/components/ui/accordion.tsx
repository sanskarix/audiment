...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "h-(--radix-accordion-content-height) pt-0 pb-4 [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-heading [&_p:not(:last-child)]:mb-4",
          className
        )}
      >
        {children}
