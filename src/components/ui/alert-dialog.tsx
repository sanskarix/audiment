  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        data-size={size}
        className={cn(
          "group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2 -translate-y-1/2 gap-6 rounded-xl bg-background/80 backdrop-blur-xl p-6 text-body shadow-2xl border border-border/50 duration-200 outline-none data-[size=default]:max-w-lg data-[size=sm]:max-w-md data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className
        )}
        {...props}
      />
...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn(
        "text-xs/relaxed text-balance font-normal text-muted-text md:text-pretty *:[a]:underline *:[a]:underline-offset-3 *:[a]:hover:text-heading",
        className
      )}
      {...props}
    />
